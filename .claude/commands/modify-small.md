---
name: modify-small
description: Make a targeted change to existing CoupleGoAI code directly with Claude. Use this for small, surgical diffs.
---
...
4. `.claude/skills/agent-workflow.md` — workflow and output rules
...
**Scope rules**
- Stay in the main Claude session
...
**All other rules from `CLAUDE.md` and the skill files still apply**
